...
const buttonVariants = cva(
  // Sharp instrument (ticket 07): Blessing's 1px hover-lift transform is gone.
  // A control on an instrument panel does not rise to meet the cursor — it
  // changes state. Feedback is carried by colour, on a faster transition.
